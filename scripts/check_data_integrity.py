...
Validates the data chain:
  structure_set -> worldgen/structure -> worldgen/template_pool -> structures/*.nbt
...
def check_structure_to_pool(worldgen_structure_dir: Path, template_pool_dir: Path) -> list[str]:
